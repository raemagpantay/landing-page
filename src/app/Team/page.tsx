...
const team = [
  {
    ...
    bg: '/images/team-dev.jpg',
    profile: '/images/rae.jpg',
  ...
  },
  {
    ...
    bg: '/images/team-ui.jpg',
    profile: '/images/prince.jpg',
  ...
  },
  {
    ...
    bg: '/images/team-artist.jpg',
    profile: '/images/rafaella.jpg',
  ...
  },
  {
    ...
    bg: '/images/team-backend.jpg',
    profile: '/images/alex.jpg',
              ...
              >
                ...
                <div className="absolute inset-0 z-0">
                  <Image
                    ...
                    priority={idx === 0}
                  />
                  <div className={`absolute inset-0 bg-gradient-to-br ${member.accent} opacity-30`} />
                </div>
                {/* Profile Image */}
